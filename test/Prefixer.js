...
describe('Prefixer', () => {
	test('flex-box', () => {
		expect(prefix(`display:block;`, 7)).to.equal([].join(''))
		...
		expect(prefix(`flex:inherit;`, 4)).to.equal([`-webkit-flex:inherit;`, `-moz-flex:inherit;`, `-ms-flex:inherit;`].join(''))
	...
	test('writing-mode', () => {
		expect(prefix(`writing-mode:none;`, 12)).to.equal([`-webkit-writing-mode:none;`, `-ms-writing-mode:none;`].join(''))
	...
	test('position', () => {
		expect(prefix(`position:relative;`, 8)).to.equal([].join(''))
	...
	test('user-select', () => {
		expect(prefix(`user-select:none;`, 11)).to.equal([`-webkit-user-select:none;`, `-moz-user-select:none;`, `-ms-user-select:none;`].join(''))
	})

	test('appearance', () => {
		expect(prefix(`appearance:none;`, 10)).to.equal([`-webkit-appearance:none;`, `-moz-appearance:none;`, `-ms-appearance:none;`].join(''))
	})
	...
	test(':read-only', () => {
		expect(prefix(`a:read-only{color:red;}`, 0)).to.equal([`a:-moz-read-only{color:red;}`].join(''))
	})

	test(':read-write', () => {
		expect(prefix(`a:read-write{color:red;}`, 0)).to.equal([`a:-moz-read-write{color:red;}`].join(''))
	})

	test('::placeholder', () => {
		expect(prefix(`a::placeholder{color:red;}`, 0)).to.equal([`a::-webkit-input-placeholder{color:red;}`, `a::-moz-placeholder{color:red;}`,`a:-ms-input-placeholder{color:red;}`].join(''))
	})
})
